...
import de.fraunhofer.iosb.ilt.faaast.registry.dtr.helper.AssetLink;
...
public class AssetAdministrationShellApiIT extends AbstractAssetAdministrationShellApi {
    ...
    public void testCreateShellExpectRegexError() throws Exception {
        ...
        mvc.perform(
                ...
                .andExpect(
                        jsonPath("$.messages[0].text", is("Asset Type doesn't match the pattern")));
    }
    ...
    public void testCreateShellWithExistingIdExpectBadRequest() throws Exception {
        ...
        mvc.perform(
                ...
                .andExpect(jsonPath("$.messages[0].text", is("AAS already exists (id: 4533ac0f-1fe0-42b1-a3dd-859ec406cb6f)")));
    }
    ...
    public void testGetShellExpectSuccess() throws Exception {
        ...
        mvc.perform(
                MockMvcRequestBuilders
                        .get(createURL(SINGLE_SHELL_BASE_PATH), TestUtil.getEncodedValue(shellId))
    ...
    public void testGetShellExpectNotFound() throws Exception {
        mvc.perform(
                MockMvcRequestBuilders
                        .get(createURL(SINGLE_SHELL_BASE_PATH), "NotExistingShellId")
                        .accept(MediaType.APPLICATION_JSON))
                .andDo(MockMvcResultHandlers.print())
    ...
    public void testUpdateShellExpectSuccess() throws Exception {
        ...
        mvc.perform(
                MockMvcRequestBuilders
                        .put(createURL(SINGLE_SHELL_BASE_PATH), TestUtil.getEncodedValue(shellId))
                        .header(EXTERNAL_SUBJECT_ID_HEADER, TenantFactory.tenantOne().getTenantId())
                        .accept(MediaType.APPLICATION_JSON)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(mapper.writeValueAsString(shellPayload)))
    ...
    public void testUpdateShellExpectNotFound() throws Exception {
        ...
        mvc.perform(
                MockMvcRequestBuilders
                        .put(createURL(SINGLE_SHELL_BASE_PATH), TestUtil.getEncodedValue("shellIdthatdoesnotexists"))
                        .accept(MediaType.APPLICATION_JSON)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(mapper.writeValueAsString(shellPayload)))
                .andDo(MockMvcResultHandlers.print())
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$.messages[0].text", is("AAS not found (id: shellIdthatdoesnotexists)")));
    }
    ...
    public void testDeleteShellExpectSuccess() throws Exception {
        ...
        mvc.perform(
                MockMvcRequestBuilders
                        .delete(createURL(SINGLE_SHELL_BASE_PATH), TestUtil.getEncodedValue(shellId))
                        .accept(MediaType.APPLICATION_JSON))
                .andDo(MockMvcResultHandlers.print())
                .andExpect(status().isNoContent());
    }
    ...
    public void testCreateShellWithSameSpecificAssetIdKeyButDifferentValuesExpectSuccess() throws Exception {
        ...
        SpecificAssetId specificAssetId1 = new DefaultSpecificAssetId();
        specificAssetId1.setName("WMI");
        specificAssetId1.setValue("identifier1ValueExample");

        SpecificAssetId specificAssetId2 = new DefaultSpecificAssetId();
    ...
    public void testCreateSpecificAssetIdsExpectSuccess() throws Exception {
        ...
        mvc.perform(
                MockMvcRequestBuilders
                        .post(createURL(SINGLE_LOOKUP_SHELL_BASE_PATH), TestUtil.getEncodedValue(shellId))
                        .accept(MediaType.APPLICATION_JSON)
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    public void testCreateSpecificIdsExpectNotFound() throws Exception {
        ...
        mvc.perform(
                MockMvcRequestBuilders
                        .post(createURL(SINGLE_LOOKUP_SHELL_BASE_PATH), TestUtil.getEncodedValue("notexistingshell"))
                        .accept(MediaType.APPLICATION_JSON)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(toJson(specificAssetIds)))
                .andDo(MockMvcResultHandlers.print())
    ...
    public void testGetSpecificAssetIdsExpectSuccess() throws Exception {
        ...
        mvc.perform(
                MockMvcRequestBuilders
                        .get(createURL(SINGLE_LOOKUP_SHELL_BASE_PATH), TestUtil.getEncodedValue(shellId))
                        .header(EXTERNAL_SUBJECT_ID_HEADER, TenantFactory.tenantOne().getTenantId())
                        .accept(MediaType.APPLICATION_JSON))
                .andDo(MockMvcResultHandlers.print())
                .andExpect(status().isOk())
    ...
    public void testGetSpecificIdsExpectNotFound() throws Exception {
        mvc.perform(
                MockMvcRequestBuilders
                        .get(createURL(SINGLE_LOOKUP_SHELL_BASE_PATH), TestUtil.getEncodedValue("notexistingshell"), TestUtil.getEncodedValue("notexistingsubmodel"))
                        .accept(MediaType.APPLICATION_JSON))
                .andDo(MockMvcResultHandlers.print())
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$.messages[0].text", is("Shell for identifier notexistingshell not found")));
    ...
    public void testCreateSubmodelWithExistingIdExpectBadRequest() throws Exception {
        ...
        mvc.perform(
                MockMvcRequestBuilders
                        .post(createURL(SUB_MODEL_BASE_PATH), TestUtil.getEncodedValue(shellId))
                        .accept(MediaType.APPLICATION_JSON)
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    public void testUpdateSubModelExpectSuccess() throws Exception {
        ...
        LangStringTextType updateDescription = new DefaultLangStringTextType();
        ...
        mvc.perform(
                MockMvcRequestBuilders
                        .put(createURL(SINGLE_SUB_MODEL_BASE_PATH), TestUtil.getEncodedValue(shellPayload1.getId()), TestUtil.getEncodedValue(submodelId))
                        .accept(MediaType.APPLICATION_JSON)
                        .contentType(MediaType.APPLICATION_JSON)
        ...
        mvc.perform(
                MockMvcRequestBuilders
                        .get(createURL(SINGLE_SUB_MODEL_BASE_PATH), TestUtil.getEncodedValue(shellPayload1.getId()), TestUtil.getEncodedValue(submodelId))
                        .accept(MediaType.APPLICATION_JSON)
                        .header(EXTERNAL_SUBJECT_ID_HEADER, TenantFactory.tenantOne().getTenantId()))
                .andDo(MockMvcResultHandlers.print())
                .andExpect(status().isOk())
    ...
    public void testUpdateSubmodelExpectNotFound() throws Exception {
        ...
        mvc.perform(
                MockMvcRequestBuilders
                        .get(createURL(SINGLE_SUB_MODEL_BASE_PATH), TestUtil.getEncodedValue("notexistingshell"), TestUtil.getEncodedValue("notexistingsubmodel"))
                        .accept(MediaType.APPLICATION_JSON)
                        .header(EXTERNAL_SUBJECT_ID_HEADER, TenantFactory.tenantOne().getTenantId()))
                .andDo(MockMvcResultHandlers.print())
                .andExpect(status().isNotFound())
        ...
        mvc.perform(
                MockMvcRequestBuilders
                        .get(createURL(SINGLE_SUB_MODEL_BASE_PATH), TestUtil.getEncodedValue(shellPayload1.getId()), TestUtil.getEncodedValue("notexistingsubmodel"))
                        .accept(MediaType.APPLICATION_JSON)
                        .header(EXTERNAL_SUBJECT_ID_HEADER, TenantFactory.tenantOne().getTenantId()))
                .andDo(MockMvcResultHandlers.print())
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$.messages[0].text", is("AAS not found (id: notexistingshell)")));
    }
    ...
    public void testUpdateSubmodelWithDifferentIdInPayloadExpectPathIdIsTaken() throws Exception {
        ...
        mvc.perform(
                MockMvcRequestBuilders
                        .put(createURL(SINGLE_SUB_MODEL_BASE_PATH), TestUtil.getEncodedValue(shellId), TestUtil.getEncodedValue(submodelId))
                        .accept(MediaType.APPLICATION_JSON)
                        .contentType(MediaType.APPLICATION_JSON)
        ...
        mvc.perform(
                MockMvcRequestBuilders
                        .get(createURL(SINGLE_SUB_MODEL_BASE_PATH), TestUtil.getEncodedValue(shellId), TestUtil.getEncodedValue(submodelId))
                        .accept(MediaType.APPLICATION_JSON)
                        .header(EXTERNAL_SUBJECT_ID_HEADER, TenantFactory.tenantOne().getTenantId()))
                .andDo(MockMvcResultHandlers.print())
                .andExpect(status().isOk())
    ...
    public void testDeleteSubmodelExpectSuccess() throws Exception {
        ...
        mvc.perform(
                MockMvcRequestBuilders
                        .delete(createURL(SINGLE_SUB_MODEL_BASE_PATH), TestUtil.getEncodedValue(shellId), TestUtil.getEncodedValue(submodelId))
                        .accept(MediaType.APPLICATION_JSON))
                .andDo(MockMvcResultHandlers.print())
                .andExpect(status().isNoContent());
    ...
    public void testDeleteSubmodelExpectNotFound() throws Exception {
        ...
        mvc.perform(
                MockMvcRequestBuilders
                        .delete(createURL(SINGLE_SUB_MODEL_BASE_PATH), TestUtil.getEncodedValue("notexistingshell"), TestUtil.getEncodedValue("notexistingsubmodel"))
                        .accept(MediaType.APPLICATION_JSON))
                .andDo(MockMvcResultHandlers.print())
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$.messages[0].text", is("Shell for identifier notexistingshell not found")));
        ...
        mvc.perform(
                MockMvcRequestBuilders
                        .delete(createURL(SINGLE_SUB_MODEL_BASE_PATH), TestUtil.getEncodedValue(shellId), TestUtil.getEncodedValue("notexistingsubmodel"))
                        .accept(MediaType.APPLICATION_JSON))
                .andDo(MockMvcResultHandlers.print())
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$.messages[0].text", is("AAS not found (id: notexistingshell)")));
    ...
    public void testCreateShellInBatchWithOneDuplicateExpectSuccess() throws Exception {
        ...
        mvc.perform(
                MockMvcRequestBuilders
                        .post(createURL(SHELL_BASE_PATH) + "/batch")
                        .accept(MediaType.APPLICATION_JSON)
                        .contentType(MediaType.APPLICATION_JSON)
